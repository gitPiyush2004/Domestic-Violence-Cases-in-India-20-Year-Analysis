...
verified (all 12 data-quality assertions pass). Still to come: the Power Query M / DAX
reference for rebuilding the model in Power BI, the Excel cleaning macro, and the
long-form `docs/` write-ups (methodology, insights, interview walkthrough).
