...
> - Delivered a **five-page Power BI dashboard with mobile layouts**, 30 DAX measures
>   including dynamic Pareto segmentation, and a guard that **returns blank rather than
>   a plausible-looking false spike** for a year with a known source gap.
